...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            // var input = $('<input type="text" class="' + search_init + sCSSClass + '" value="' + inputvalue + '" rel="' + i + '"/>');//original
            //Agregar Oscar Estuvo por aqui
            ...
            label = '';//Agregar Oscar Estuvo por aqui
            asInitVals[i] = label;
            var index = i;
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            for (j = 0; j < iLen; j++) {
                if (typeof (aData[j]) != 'object') {
                    ...
                    var selected = '';
                    //Esto lo modifique quitando el escape Oscar estuvo aqui!! joshua dijo que por aqui pasaras.
                    if (bRegex) {
